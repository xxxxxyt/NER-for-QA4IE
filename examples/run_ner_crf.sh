#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python examples/NERCRF.py --mode LSTM \
 --num_epochs 200 --batch_size 16 --hidden_size 256 --num_layers 1 \
 ...
 --train "data/conll2003/english/eng.train.bioes.conll" \
 --dev "data/conll2003/english/eng.dev.bioes.conll" \
